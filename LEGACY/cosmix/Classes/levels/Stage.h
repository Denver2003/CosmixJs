...
public:
    Stage();
	Stage(string _label, float _time, int _points, int _starOne, int _starTwo, int _starThree, int _rotationAngle, int _bonusTime,int _minFigures);
	~Stage(void);
    void Init(string _label, float _time, int _points, int _starOne, int _starTwo,int _starThree,int _rotationAngle, int _bonusTime, int _minFigures);
    
    //---------------------------------------
    void addFigure(Figure * figure);
    
    Figure * randomFigure();
    Figure * getFigureByColor(int color_index);
