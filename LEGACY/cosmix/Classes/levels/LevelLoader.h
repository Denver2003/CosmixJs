...
#define ARRAY_FROM_DICT(dict,name) ((CCArray *)dict->objectForKey(name))
...
//    bool setNextLevel();
    ...
    vector<vector<string> > loadInfos(CCArray * dictInfos);
    
    void setStageFiguresCleared(int points);
    void addStageFiguresCleared(int points);
