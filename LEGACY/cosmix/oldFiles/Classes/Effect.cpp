...
vector<CCAction *> Effect::pointsFly(CCAction * toEndAction){
    ...
    ret.push_back(CCSequence::create(scale1,scale2,scale3,scale4,scale5,NULL));

    CCMoveBy *		moveAction		= CCMoveBy::create( 2, ccp( 0, 30 ));
    ret.push_back(CCSequence::create( moveAction,toEndAction,NULL ));

    CCFadeTo *      fadeAction      = CCFadeTo::create(1.7, 0 );
