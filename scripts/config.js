...
export const CHAIN_HALO_ALPHA_MIN = 0.2;
export const CHAIN_HALO_ALPHA_MAX = 0.35;
export const CHAIN_HALO_BLUR_MIN = 4;
export const CHAIN_HALO_BLUR_MAX = 8;
export const CHAIN_SHIMMER_STEP_MS = 200;
export const CHAIN_SHIMMER_COOLDOWN_MS = 4500;
export const CHAIN_SHIMMER_DURATION_MS = 450;
export const CHAIN_SHIMMER_BAND_RATIO = 0.22;
export const CHAIN_SHIMMER_ALPHA = 0.22;
