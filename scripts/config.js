...
export const SHAPE_SPRITE_PACK = "assets/shape_sprites/pack_default";
...
export const PREVIEW_FILL_ALPHA = 0.45;
export const WAITING_FILL_ALPHA = 0.65;
export const CHAIN_FILL_BASE = 0.6;
export const CHAIN_FILL_STEP = 0.1;
export const CHAIN_FILL_MAX = 0.9;
export const CHAIN_BLINK_ALPHA_MIN = 0.55;
export const CHAIN_BLINK_ALPHA_MAX = 0.75;
export const WAIT_FILL_OVERLAY_ALPHA = 0.35;
export const CHAIN_HALO_PAD_PX = 3;
export const CHAIN_HALO_ALPHA_MIN = 0.35;
export const CHAIN_HALO_ALPHA_MAX = 0.55;
export const CHAIN_HALO_BLUR_MIN = 10;
export const CHAIN_HALO_BLUR_MAX = 16;
export const CHAIN_SHIMMER_STEP_MS = 200;
export const CHAIN_SHIMMER_COOLDOWN_MS = 3000;
export const CHAIN_SHIMMER_DURATION_MS = 1000;
export const CHAIN_SHIMMER_BAND_RATIO = 0.35;
export const CHAIN_SHIMMER_ALPHA = 0.35;
export const CHAIN_BURST_DURATION_MS = 1000;
...
export const VFX_TEXT_SCALE_MIN = 0.5;
export const VFX_TEXT_SCALE_MAX = 1;
