...
const STRINGS = {
  en: {
    ...
    "app.title_line1": "Falling Blocks",
    "app.title_line2": "Physics Puzzle",
    ...
    "pause.resume_hint": "PRESS P TO RESUME",
    "hud.level_short": "LVL {level}",
    "combo.basic": "COMBO",
    "combo.super": "SUPER COMBO",
    "combo.mega": "MEGA COMBO",
    "combo.cosmo": "COSMO COMBO",
    "level_up.new": "NEW",
    "level_up.label": "LEVEL",
    "bonus.touch.title": "TOUCH TO KILL",
    "bonus.touch.body": "TAP FIGURES TO DESTROY",
    "bonus.touch.ends_in": "ENDS IN {seconds}s",
    ...
    "bonus_upgrade.level_5": "Cooldown 3 min",
    "bonus_upgrade.level_6": "Instant always in bubble",
    "bonus_upgrade.level_7": "Consumables x5, cap 3",
  ...
  ru: {
    ...
    "app.title_line1": "Падающие Блоки",
    "app.title_line2": "Физическая Головоломка",
    ...
    "pause.resume_hint": "НАЖМИ P, ЧТОБЫ ПРОДОЛЖИТЬ",
    "hud.level_short": "УР. {level}",
    "combo.basic": "КОМБО",
    "combo.super": "СУПЕР КОМБО",
    "combo.mega": "МЕГА КОМБО",
    "combo.cosmo": "КОСМО КОМБО",
    "level_up.new": "НОВЫЙ",
    "level_up.label": "УРОВЕНЬ",
    "bonus.touch.title": "УНИЧТОЖЕНИЕ ПО ТАПУ",
    "bonus.touch.body": "ТАПАЙ ФИГУРЫ, ЧТОБЫ УНИЧТОЖИТЬ",
    "bonus.touch.ends_in": "КОНЕЦ ЧЕРЕЗ {seconds}с",
    ...
    "bonus_upgrade.level_5": "Кулдаун 3 мин",
    "bonus_upgrade.level_6": "Мгновенные всегда в пузыре",
    "bonus_upgrade.level_7": "Расходники x5, лимит 3",
