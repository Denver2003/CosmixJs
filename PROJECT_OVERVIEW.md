...
2. Core Gameplay Loop
	...
	5.	Если цепочка одного цвета ≥ 5 фигур и стабильна ≥ 3 секунд → происходит сокращение.
...
Rotation
	...
	•	Диапазон угла расширяется с ростом уровня
...
6. Chain Detection
	•	Минимум фигур в цепочке: 5
	•	Касание: достаточно минимального контакта (ребро/вершина)
	•	Зона контакта расширена на несколько пикселей
	•	Таймер стабильности: 3 секунды
	•	Любое движение или изменение цепочки → таймер сбрасывается
...
Energy Rules
	...
	•	Energy постепенно охлаждается со временем

Thresholds
	•	Energy ≥ L2 → ×2
	•	Energy ≥ L3 → ×3
	•	Полный заряд → ×5 на 10 сек, охлаждение заморожено
	•	После ×5: охлаждение ×3 на 30 сек
